...
class HyperJsonGenerator:
    ...
    def general(self, k: float = 0.9, k_bounds: Tuple[float, float] = (0.5, 1.0),
        ...
        return {
            ...
            'p_type': ['Additive_p', 'fixed'],
            'probability_AtomicNumber': {'Const_p': [1.0, "fixed"]},
            'probability_group_an5': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an6': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an7': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an8': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an9': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an14': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an15': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an16': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an17': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an35': {'Assign_p': [p, p_bounds, 0.5]},
            'probability_group_an53': {'Assign_p': [p, p_bounds, 0.5]},
            'q': [0.01, (0.01, 0.5), 0.01],
        }
