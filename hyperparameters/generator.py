...
class HyperJsonGenerator:
    ...
    def tensorproduct(self, elemental_mode=False, reaction=0,
        ...
        tp.update({
            'atom_AtomicNumber_1': [['kConv', 0.9, self.k_bounds]],
            'atom_AtomicNumber_2': [['kConv', 0.9, self.k_bounds]],
            'atom_AtomicNumber_3': [['kConv', 0.9, self.k_bounds]],
            ...
            #'atom_Aromatic_4': [['kConv', 0.9, self.k_bounds]],
            'atom_RingNumber': [['kDelta', 0.9, self.k_bounds]],
            #'atom_Chiral': [['kDelta', 0.9, self.k_bounds]],
            # 'atom_chiral_1': [['kConv', 0.9, self.k_bounds]],
            #'atom_hybridization': [['kDelta', 0.9, self.k_bounds]],
            'atom_RingMembership': [['kConv', 0.9, self.k_bounds]],
            # 'atom_Charge': [['kDelta', 0.9, self.k_bounds]],
            #'atom_Charge': [['sExp', 2.5, self.k_bounds]],
            'atom_MorganHash': [['kDelta', 0.9, self.k_bounds]],
            #'atom_InRing': [['kDelta', 0.9, self.k_bounds]],
            #'bond_InRing': [['kDelta', 0.9, self.k_bounds]],
            'atom_FirstNeighbors': [['kDelta', 0.9, self.k_bounds]],
            'atom_SecondNeighbors': [['kDelta', 0.9, self.k_bounds]],
            #'atom_third_neighbors': [['kDelta', 0.9, self.k_bounds]],
            #'atom_fourth_neighbors': [['kDelta', 0.9, self.k_bounds]],
            #'atom_hcount_1': [['kConv', 0.9, self.k_bounds]],
            # 'atom_hcount_2': [['kConv', 0.9, self.k_bounds]],
            #'atom_hcount_3': [['kConv', 0.9, self.k_bounds]],
            #'atom_hcount_4': [['kConv', 0.9, self.k_bounds]],
            'atom_Hcount': [['kDelta', 0.9, self.k_bounds]],
            # 'atom_FirstNeighbors_1': [['kConv', 0.9, self.k_bounds]],
            # 'atom_FirstNeighbors_2': [['kConv', 0.9, self.k_bounds]],
    ...
    def additive(self, elemental_mode=False, reaction=False,
        ...
        ad.update({
            ...
            'atom_RingNumber': [['kC', 0.5, [0.01, 1.0]], ['kDelta', 0.9, self.k_bounds]],
            'atom_chiral': [['kC', 0.5, [0.01, 1.0]], ['kDelta', 0.5, self.k_bounds]],
            'atom_hybridization': [['kC', 0.5, [0.01, 1.0]], ['kDelta', 0.9, self.k_bounds]],
            'atom_RingMembership': [['kC', 0.5, [0.01, 1.0]], ['kConv', 0.9, self.k_bounds]],
